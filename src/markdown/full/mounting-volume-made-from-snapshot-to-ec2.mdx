...
* https://forums.aws.amazon.com/thread.jspa?messageID=114594 Mounting EBS volume (mount: wrong fs type, bad option, bad superblock)
* https://bbs.archlinux.org/viewtopic.php?id=218883 [Solved] Nextcloud, change Data folder location
* https://docs.nextcloud.com/server/21/admin_manual//maintenance/migrating_owncloud.html Migrating from ownCloud
