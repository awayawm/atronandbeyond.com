...
<img alt="e-board connected to a PC running LiveChess"
     src="https://s3.us-west-2.amazonaws.com/atronandbeyond.com/atronandbeyond-images/dgt-board-setup.jpg"/>

E-board connected to a PC running Live Chess
