...
<Carousel>
    <Card elevation={0}>
        <CardMedia component="img"
                   image="https://s3.us-west-2.amazonaws.com/atronandbeyond.com/atronandbeyond-images/livechess-7.PNG"
                   alt="Once start recording is selected a recording link appears"/>
        <CardContent style={{textAlign:'center'}}>
            Once start recording is selected a recording link appears
        </CardContent>
    </Card>
    <Card elevation={0}>
        <CardMedia component="img"
                   image="https://s3.us-west-2.amazonaws.com/atronandbeyond.com/atronandbeyond-images/livechess-8.PNG"
                   alt="Since we only have one round it's okay for the pgn to be in one file and we don't need the extra fields e-pgn provides"/>
        <CardContent style={{textAlign:'center'}}>
            The recording screen will show the initial moves
        </CardContent>
    </Card>
    <Card elevation={0}>
        <CardMedia component="img"
                   image="https://s3.us-west-2.amazonaws.com/atronandbeyond.com/atronandbeyond-images/livechess-9.PNG"
                   alt="After entering in the tournament details enter some player information"/>
        <CardContent style={{textAlign:'center'}}>
            New moves are show in the recording window.  Pgn can be edited manually here as well
        </CardContent>
    </Card>
    <Card elevation={0}>
        <CardMedia component="img"
                   image="https://s3.us-west-2.amazonaws.com/atronandbeyond.com/atronandbeyond-images/livechess-10.PNG"
                   alt="Moves are written to the file on disk as they are played"/>
        <CardContent style={{textAlign:'center'}}>
            Moves are written to the file on disk as they are played
        </CardContent>
    </Card>
</Carousel>
...
* <Link href="https://github.com/jhlywa/chess.js/#history-options-">.history([ options ])</Link> returns a list of all the moves containing all kinds of useful data.  We'll be checking its <Link href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/length">.length</Link>
